...
insert into Usuarios (email, nombre, apellido, rol) values ('ana0@google.com', 'Ana', 'Alvarez', 'administrador');
insert into Usuarios (email, nombre, apellido, rol) values ('sofia@gmail.com', 'Sofia', 'Carmona', 'usuario');
insert into Usuarios (email, nombre, apellido, rol) values ('angel@yahoo.com', 'Angel', 'Espinoza', 'usuario');
insert into Usuarios (email, nombre, apellido, rol) values ('marizol@hotmail.com', 'Marizol', 'Fernandez', 'usuario');
insert into Usuarios (email, nombre, apellido, rol) values ('javiera@amazon.com', 'Javier', 'Gutierrez', 'usuario');
...
VALUES 
    ('Beinvenido a mi pagina', 'Iniciate en el mundo de la reposteria.', '2024-18-03', '2024-15-02', true, 2),
    ('Cupcakes', 'Elaboremos postres saludables y deliciosos siguiendo las recetas', '2024-11-01', '2024-02-28', true, 2),
    ('Super Postres!', 'Descrubre los ingredientes mas nutritivos que puedes agregar a tus postres', '2024-04-03', '2024-03-27', true, 1),
    ('Secretos de la crema batida', 'Aca encontraras varias soluciones para que tu crema batida sea para todas las estaciones', '2024-03-04', '2024-07-28', false, 3),
    ('Coconuts', 'Las mejores recetas con las mil y una manera de cocinar el coco', '2024-04-07', '2024-07-01', false, NULL);
